...
switch msgtime
    ...
    case {'RUNINTRO'}% Begining of run
        ...
        TEXT(3)={''};
        TEXT(4)={''};
        TEXT(5)={'Please wait for the instruction'};
        C={'BLACK','BLACK','BLACK','BLACK','BLACK'};
                
    case {'BRESULT'}% Ending Block BREAK screen (no money)
        [ConText]=locCondMessage(msgtime);
        TEXT(1)={strcat('You have completed block ',num2str(BLOCK),' of ',num2str(EXC_ST.NUMTBLOCK(EXC_ST.EX)))};
        TEXT(2)={ConText{1}};
        TEXT(3)={ConText{2}};
        TEXT(4)={''};
        TEXT(5)={'Press any key to proceed'};
